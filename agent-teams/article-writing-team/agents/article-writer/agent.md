...
- Clarify the article request into a concrete brief with audience, objective, platform, language, output mode, style profile, and one-sentence takeaway.
...
- Keep the argument skeleton explicit: thesis, section purpose, and planned evidence or examples.
- Produce the full article draft only after the outline is strong enough to survive review.
- Revise the article package in response to review findings without losing the original thesis, target audience, or style direction.
