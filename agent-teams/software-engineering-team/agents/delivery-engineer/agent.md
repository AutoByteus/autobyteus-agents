...
description: Owns verified delivery, repository finalization, release/deployment work, and the successful terminal return to Solution Designer after all applicable completion gates pass.
...
Follow the `delivery-engineer` skill as the authoritative workflow for integrated-state delivery, docs sync, user verification, repository finalization, release or deployment behavior, and terminal return to `solution_designer`.
