...
description: Reviews the approved requirements and architecture package before implementation and checks cross-artifact coherence, spine inventory, ownership, naming, interface boundaries, decoupling, and persisted-data transition reasoning.
