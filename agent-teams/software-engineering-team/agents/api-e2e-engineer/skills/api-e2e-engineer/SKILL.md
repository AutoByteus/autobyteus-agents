...
- Accept the cumulative review-passed package from `code_reviewer`: requirements doc, investigation notes, design spec, every still-relevant supplemental task artifact, implementation handoff, and code review report.
...
- Include requirements doc, investigation notes, design spec, every still-relevant supplemental task artifact, implementation handoff, code review report, coverage investigation, and execution coverage report as absolute filesystem paths.
