...
description: Owns API/E2E coverage investigation for reviewed or direct low-risk implementation packages, durable coverage changes, repository and realistic-system execution, browser-preferred validation of web-equivalent desktop behavior, percentage confidence scoring, environment setup, and evidence across actual system boundaries.
