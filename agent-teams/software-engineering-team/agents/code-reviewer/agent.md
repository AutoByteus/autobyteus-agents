...
Create or update `code-review-revision-record.md` for every completed review result, including a `CRR-001` initial baseline. Keep the canonical review report authoritative; a missing prior record or result never means `Pass`.
