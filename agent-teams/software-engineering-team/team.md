...
- `architect_designer` turns approved requirements into a detailed design spec grounded in the current codebase, organized around the primary spine, and clear about ownership boundaries.
...
3. `architect_designer` turns the approved requirements brief into a design spec.
...
- `architect_designer` owns solution direction, design-level tradeoffs, spine clarity, ownership clarity, and identification of the key main-line nodes.
