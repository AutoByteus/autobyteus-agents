...
- Status: Draft / Ready for page generation / Revised / Approved for review
- Project folder:
- Brief path:
- Storyboard path:
...
| Revision ID | Character ID | Previous Reference Path | New Reference Path | Affected Pages | Required Follow-Up |
| --- | --- | --- | --- | --- | --- |
| ref-rev001 |  |  |  |  | recheck / edit pages / regenerate pages / regenerate colored references |
