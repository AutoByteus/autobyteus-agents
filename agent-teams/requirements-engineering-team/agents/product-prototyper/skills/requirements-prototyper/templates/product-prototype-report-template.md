...
| Journey / Screen / Scenario | Product Behavior Made Runnable | Evidence | Result |
| --- | --- | --- | --- |
|  |  |  |  |

## Validation

| Check / Command / Viewport | Result | Evidence / Notes |
| --- | --- | --- |
|  |  |  |
...
| Decision Question / ID | Alternatives Explored | Observed Evidence | Recommendation | User Decision Still Required |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |
